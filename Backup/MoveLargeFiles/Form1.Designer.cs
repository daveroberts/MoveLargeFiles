namespace MoveLargeFiles
{
	partial class frm
	{
		...
		private void InitializeComponent()
		{
			...
			this.pnlNoDirectories = new System.Windows.Forms.Panel();
			this.label5 = new System.Windows.Forms.Label();
			this.pnlNoDirectories.SuspendLayout();
			this.SuspendLayout();
			// 
			// lstDirectories
			// 
			...
			// pnlNoDirectories
			// 
			this.pnlNoDirectories.AllowDrop = true;
			this.pnlNoDirectories.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
						| System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this.pnlNoDirectories.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(192)))), ((int)(((byte)(255)))));
			this.pnlNoDirectories.Controls.Add(this.label5);
			this.pnlNoDirectories.Location = new System.Drawing.Point(12, 9);
			this.pnlNoDirectories.Name = "pnlNoDirectories";
			this.pnlNoDirectories.Size = new System.Drawing.Size(546, 400);
			this.pnlNoDirectories.TabIndex = 10;
			this.pnlNoDirectories.DragDrop += new System.Windows.Forms.DragEventHandler(this.pnlNoDirectories_DragDrop);
			this.pnlNoDirectories.DragEnter += new System.Windows.Forms.DragEventHandler(this.pnlNoDirectories_DragEnter);
			// 
			// label5
			// 
			...
			this.Controls.Add(this.pnlNoDirectories);
			...
			this.pnlNoDirectories.ResumeLayout(false);
			this.pnlNoDirectories.PerformLayout();
		...
		private System.Windows.Forms.Panel pnlNoDirectories;
